Membership.Segmentation.v2 <- read.csv("~/Downloads/_ Membership Segmentation v2.csv")
View(Membership.Segmentation.v2)
attach(Membership.Segmentation.v2)
...
Membership.Segmentation.v2$student<-ifelse(Membership.Segmentation.v2$member_type_category=="Student"|Membership.Segmentation.v2$member_type_category=="Undergrad",1,0)
attach(segmentation)
View(segmentation)
table(Membership.Segmentation.v2$student)
Membership.Segmentation.v2<-subset(Membership.Segmentation.v2,Membership.Segmentation.v2$student==0)
attach(segmentation)
View(segmentation)


names(Membership.Segmentation.v2)
...
segmentation<-Membership.Segmentation.v2[keepvars]
attach(segmentation)
View(segmentation)
names(segmentation)
detach(Membership.Segmentation.v2)
