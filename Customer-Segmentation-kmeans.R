_.Membership.Segmentation.v2 <- read.csv("~/Downloads/_ Membership Segmentation v2.csv")
View(_.Membership.Segmentation.v2)
attach(_.Membership.Segmentation.v2)
...
_.Membership.Segmentation.v2$student<-ifelse(_.Membership.Segmentation.v2$member_type_category=="Student"|_.Membership.Segmentation.v2$member_type_category=="Undergrad",1,0)
attach(segmentation)
View(segmentation)
table(_.Membership.Segmentation.v2$student)
_.Membership.Segmentation.v2<-subset(_.Membership.Segmentation.v2,_.Membership.Segmentation.v2$student==0)
attach(segmentation)
View(segmentation)


names(_.Membership.Segmentation.v2)
...
segmentation<-_.Membership.Segmentation.v2[keepvars]
attach(segmentation)
View(segmentation)
names(segmentation)
detach(_.Membership.Segmentation.v2)
